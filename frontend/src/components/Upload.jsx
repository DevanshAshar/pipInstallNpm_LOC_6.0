...
const Upload = () => {
  ...
  return (
    <div>
        ...
        <div className='card'>
            <div className='top'>
                <Typography variant='h4' style={{color: 'white', marginTop: '20px', background: 'linear-gradient(-50deg, #37BFD1, #C1F3F5)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Upload Images of Room</Typography>
            </div>
